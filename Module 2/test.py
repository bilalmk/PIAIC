...
#path = "photos"
#print(len([name for name in os.listdir(path) if name.endswith(".jpg") or name.endswith(".jpeg") or name.endswith(".png") ]))
        ...
        for fname in fileList:
            ...
            if(allowed_file(fname)):
                ...
                if(width>=200 and height>=200):
                    ...
                    #img = np.array(image.open(rootDir+"/"+fname).resize((200,200)))
